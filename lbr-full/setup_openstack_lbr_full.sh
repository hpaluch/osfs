...
[ -f $STAGE ] || {
	...
	sudo crudini --set $f ml2 mechanism_drivers "linuxbridge,l2population"
	...
	sudo crudini --set $f vxlan enable_vxlan True
	sudo crudini --set $f vxlan l2_population True
	sudo crudini --set $f vxlan local_ip $OVERLAY_INTERFACE_IP_ADDRESS
